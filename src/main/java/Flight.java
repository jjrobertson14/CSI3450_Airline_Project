...
public class Flight {
	...
	public Flight(int id, int aircraftID, int sourceAirportID, int destAirportID, Timestamp departureTime,
			Timestamp arrivalTime, Timestamp recordedDepartureTime, Timestamp recordedArrivalTime, boolean cancelled) {
		this.id = id;
		this.aircraftID = aircraftID;
		this.sourceAirportID = sourceAirportID;
		this.destAirportID = destAirportID;
	...
	public void setRecordedDepartureTime(Timestamp time) {
	...
	public void setRecordedArrivalTime(Timestamp time) {
